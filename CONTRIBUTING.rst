...
1. Fork `sphinx-py3doc-enhanced-theme <https://github.com/ionelmc/sphinx-py3doc-enhanced-theme>`_
   (look for the "Fork" button).
2. Clone your fork locally::

    git clone git@github.com:YOURGITHUBNAME/sphinx-py3doc-enhanced-theme.git
...
.. [1] If you don't have all the necessary python versions available locally you can rely on Travis - it will
       `run the tests <https://travis-ci.com/github/ionelmc/sphinx-py3doc-enhanced-theme/pull_requests>`_
