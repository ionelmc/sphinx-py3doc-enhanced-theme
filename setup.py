...
setup(
    ...
    project_urls={
        'Changelog': 'https://github.com/ionelmc/sphinx-py3doc-enhanced-theme/blob/master/CHANGELOG.rst',
        'Issue Tracker': 'https://github.com/ionelmc/sphinx-py3doc-enhanced-theme/issues',
    },
    keywords=[
